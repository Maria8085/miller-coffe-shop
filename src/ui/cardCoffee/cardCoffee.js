...
function CardCoffee({isResale}) {
    return (
        <div className={cn("cardCoffee", isResale && "resale") }>
            <div className="note">
                <div className="noteText">
                    {isResale ?
                    "Скидка":<>Популярное<br/>Новый урожай</>}
                </div>
                <div className="volume">
                    <select className="cooseVolume">
                        <option value="" selected>250г.</option>
            ...
            <p className="coffeeText">Свежеобжаренный кофе - описание товара, вкус, аромат</p>
